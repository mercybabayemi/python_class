...
secondCitizenName = input("Enter second citizen's name: ")
...
if first_citizen_earning <= 30000:
	...
	print(first_citizen_name, "earning of", first_citizen_earning, "total tax is", first_total_tax )
...
if second_citizen_earning <= 30000:
	...
	print(second_citizen_name, " earning of ", second_citizen_earning, " total tax is " , second_total_tax )
...
if third_citizen_earning <= 30000:
	...
	print(third_citizen_name, " earning of ", third_citizen_earning,  " total tax is ", third_total_tax )
