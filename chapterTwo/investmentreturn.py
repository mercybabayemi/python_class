...
print(f"The amount on deposit at the end of ten years is {amount_deposit_in_ten_years}")

print(f"The amount on deposit at the end of twenty years is {amount_deposit_in_twenty_years}")

print(f"The amount on deposit at the end of thirty years is {amount_deposit_in_thirty_years}")
